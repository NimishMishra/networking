...
(() => {
    ...
    image.addEventListener('load', () => {
        ...
        ctx.strokeText('Welcome to a place where your dreams dont matter', 90, 160);
        ctx.fillText('Welcome to a place where your dreams dont matter', 90, 160);

        ctx.strokeText('Makelarides are performing black magic 🧙', 113, 190);
        ctx.fillText('Makelarides are performing black magic 🧙', 113, 190);
